      <div class="corp_box_main">
        <div class="corp_box_top"><img width="225" height="23" alt="User Options" src="/img/box_useroptions.gif"></div>
      ...
      <div class="corp_box_main">
        <div class="corp_box_top"><img width="225" height="23" alt="Site Features" src="/img/box_sitefeatures.gif"></div>
        <div class="corp_box_side"></div>
        <div class="corp_box_content">
          <div class="pad">
