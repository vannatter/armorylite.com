...
<div id="stats_head_spell" class="stats_head_spell stats_head_off stats_toggle" data-statname="spell" <?= ((@$i) ? " data-multi_id='" . $i . "' " : ''); ?>><?= __('Spell Statistics'); ?></div>
<div style="display: none;" id="stats_main_spell" class="stats_main_spell stats_main" <?= ((@$i) ? " data-multi_id='" . $i . "' " : ''); ?>><center>
